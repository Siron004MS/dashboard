...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Ricky');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Ricky');

      cy.get(`[data-cy="lastName"]`).type('Bailey');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Bailey');

      cy.get(`[data-cy="email"]`).type('Horacio81@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Horacio81@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('speedily reorganisation outside');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'speedily reorganisation outside');

      cy.get(`[data-cy="hireDate"]`).type('2025-05-21T15:22');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-05-21T15:22');

      cy.get(`[data-cy="salary"]`).type('25676');
      cy.get(`[data-cy="salary"]`).should('have.value', '25676');

      cy.get(`[data-cy="commissionPct"]`).type('25288');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '25288');
