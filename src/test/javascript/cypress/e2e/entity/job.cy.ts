...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Product Tactics Associate');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Product Tactics Associate');

      cy.get(`[data-cy="minSalary"]`).type('18316');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '18316');

      cy.get(`[data-cy="maxSalary"]`).type('18760');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '18760');
