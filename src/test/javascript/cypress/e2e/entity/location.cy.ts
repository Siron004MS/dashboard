...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('even');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'even');

      cy.get(`[data-cy="postalCode"]`).type('incidentally yet when');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'incidentally yet when');

      cy.get(`[data-cy="city"]`).type('Fort Myrnaberg');
      cy.get(`[data-cy="city"]`).should('have.value', 'Fort Myrnaberg');

      cy.get(`[data-cy="stateProvince"]`).type('yuck helplessly');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'yuck helplessly');
