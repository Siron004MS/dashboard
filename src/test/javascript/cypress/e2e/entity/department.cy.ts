...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'playfully what after' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('quick kindly');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'quick kindly');
