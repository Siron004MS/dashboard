...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'caabfefc-eb65-4dfe-824d-718cba68432c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c8101d13-626e-499d-bdd1-1caf786c87f2');
      cy.get(`[data-cy="name"]`).should('have.value', 'c8101d13-626e-499d-bdd1-1caf786c87f2');
